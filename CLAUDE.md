...
- **Docs flow**: substantive notes, explanations, and caveats produced while working are persisted into `README.md` here — not left in chat. Improvement suggestions for the DSL package go into `../declarative-requests-swift/TODO.md`, not into its sources; never modify that package's code unless explicitly asked.
